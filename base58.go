...
func base58_check_encoding_test() {
    vk,_ := hex.DecodeString("c8e90996c7c6080ee06284600c684ed904d14c5c");
    b58enc := base58CheckEncodeKey(byte(0), vk);
    fmt.Println(b58enc);
    b58dec := base58CheckDecodeKey(b58enc);
    fmt.Println(hex.EncodeToString(b58dec));
}
